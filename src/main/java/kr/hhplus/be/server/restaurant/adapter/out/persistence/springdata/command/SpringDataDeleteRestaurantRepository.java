...
import kr.hhplus.be.server.restaurant.adapter.out.persistence.jpa.command.JpaDeleteRestaurantRepository;
import kr.hhplus.be.server.restaurant.application.port.out.repository.command.DeleteRestaurantRepository;
